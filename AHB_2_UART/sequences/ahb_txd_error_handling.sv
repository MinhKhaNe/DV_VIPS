class ahb_txd_error_handling extends uvm_sequence #(ahb_transaction);
  `uvm_object_utils(ahb_txd_error_handling)
  ...
  function new(string name = "ahb_txd_empty_error_handling");
    super.new(name);
  endfunction
  ...
  virtual task body();
    ...
    //for(int i = 0; i < 17; i++) begin
      ...
      //TX_EMTPY_FULL_ENABLE
      //write_ahb(IER, 32'h03);
      ...
      //    `uvm_info(get_type_name(), $sformatf("\n===== PASSED SUCCESSFULLY!!! TX FULL Status is high ====="), UVM_LOW)
      //  end
      //end
   //end
  endtask
