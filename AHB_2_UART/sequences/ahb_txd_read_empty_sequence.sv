class ahb_txd_read_empty_sequence extends uvm_sequence #(ahb_transaction);
  `uvm_object_utils(ahb_txd_read_empty_sequence)
  ...
  bit [31:0] lcr;
  function new(string name = "ahb_txd_read_empty_sequence");
    super.new(name);
  endfunction
