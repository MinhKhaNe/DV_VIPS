class ahb_rxd_rx_full_sequence extends uvm_sequence #(ahb_transaction);
  `uvm_object_utils(ahb_rxd_rx_full_sequence)
  ...
  function new(string name = "ahb_rxd_rx_full_sequence");
    super.new(name);
  endfunction
    ...
    //for(int i = 0; i < 16; i++) begin
      ...
      if(cfg.sampling == uart_configuration::MODE_X16) begin
        case(cfg.baud_rate)
          ...
          38400: begin
            write_ahb(DLL, 32'hA3);   //A2 -> PASSED, A3 -> FAILED
